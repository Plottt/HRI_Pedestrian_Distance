...
def get_all_frames(bag_file, start_frame, end_frame):
    ...
    config = rs.config()
    # config.enable_stream(rs.stream.color, 640, 480, rs.format.rgb8, 15)  # Reduce resolution
...
def animate_point_cloud():
    ...
    def update(frame_idx):
       ...
       # Filter sampled vertices within bounds
        ...
        rot_angle = fit_line_and_find_rotation(filtered_sampled_vertices)
...
rotation_angle_deg = -51
start_frame = 600
end_frame = 675
cutoff_dist = 1.5 # meters
csv_fileName = 'participant_data/trajectories2/trash.csv'
# video_fimeName = 'participant_data/videos2/person1.mp4'

if __name__ == '__main__':
    bag_file = "participant_data/20241113_181610.bag"  # Replace with your .bag file path
    global all_vertices
